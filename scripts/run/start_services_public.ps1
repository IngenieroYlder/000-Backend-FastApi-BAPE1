...
$backendCmd = "cd 'd:\Colombia Picture\n8n agente ia burbuja\000 Backend FastApi BAPE'; $host.ui.RawUI.WindowTitle = 'OFFICIAL BAPE BACKEND (PUBLIC + NGROK)'; & '.\venv\Scripts\python.exe' scripts\run\start_public.py"
